          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div className="container3">
                ...
                <ul>
                  <li>
                    <strong>Define US education & career goals: </strong> Decide
                    target universities based on background, US location, career
              ...
              <ul>
                <li>
                  ...
                  sample, sample recommendation letters, financial planning, and
                  career goals
                </li>
                <li>
