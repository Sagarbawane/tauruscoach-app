...
class ER1 extends React.Component {
  constructor(props) {
    super(props);
  }
  handleBooknow = () => {
    const data = {
      serviceName: "Essay Review (ER)",
      price: "US $250.00",
    };
              ...
              <div class="col-md-6">
                <div className="container3">
                  ...
                  <ul>
                    <li>
                      <strong>
                        Make a convincing case for your candidacy:{" "}
                      </strong>{" "}
                ...
                <ul>
                  <li>
                    ...
                    Please note that we do not write the essay for you. You
                    write the essay; we make it impactful.
                  </li>
                  <li>
...
export default connect(mapStateToProps)(ER1);
